...
thresholdUMCU_3TMB = [700, 750, 800, NaN, 700, 950  NaN, NaN, NaN];
thresholdUMCU_7TGE = [150, 100, 100, NaN, 200, 300, NaN, NaN, 250];
thresholdUMCU_7TSE = [50, 50];
...
nifti = '/Fridge/users/margriet/subjects/bids_umcupreproc/sub-visual01/ses-UMCU7TSE/sub-visual01_ses-UMCU7TSE_task-bairprf_run-01_bold/sub-visual01_ses-UMCU7TSE_task-bairprf_run-01_bold-masked-mc-warp.nii';
...
niftiwrite(mean_nii, '/Fridge/users/margriet/projects/analysis/analyzeprf/results/umcu/sub-visual01/ses-UMCU7TSE/mean.nii', hdr);
