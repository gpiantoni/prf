...
thresholdUMCU_3TMB = [700, 750, 200, NaN, 800, 950  NaN, NaN, NaN];
thresholdUMCU_7TGE = [150, 100, 100, NaN, 100, 300, NaN, NaN, 250];
thresholdUMCU_7TSE = [50, 50, 50, NaN, 175];
...
nifti_run1 = niftiread (['/Fridge/users/margriet/subjects/bids_umcupreproc/', subjectcode, '/ses-UMCU3TMB/merged_bairprf/', subjectcode, '_ses-UMCU3TMB_task-bairprf_run-01_bold.nii']);
nifti_run2 = niftiread (['/Fridge/users/margriet/subjects/bids_umcupreproc/', subjectcode, '/ses-UMCU3TMB/merged_bairprf/', subjectcode, '_ses-UMCU3TMB_task-bairprf_run-02_bold.nii']);
n_volumes_run1 = size(nifti_run1, 4);
n_volumes_run2 = size(nifti_run2, 4);
n_volumes = [n_volumes_run1, n_volumes_run2];

nifti_merged = ['/Fridge/users/margriet/subjects/bids_umcupreproc/', subjectcode, '/ses-UMCU3TMB/merged_bairprf/', subjectcode, '_ses-UMCU3TMB_task-bairprf_MERGED_bold/', subjectcode, '_ses-UMCU3TMB_task-bairprf_MERGED_bold-masked-mc-warp.nii'];
...
nifti_run1 = niftiread (['/Fridge/users/margriet/subjects/bids_umcupreproc/', subjectcode, '/ses-UMCU7TGE/merged_bairprf/', subjectcode, '_ses-UMCU7TGE_task-bairprf_run-01_bold.nii']);
nifti_run2 = niftiread (['/Fridge/users/margriet/subjects/bids_umcupreproc/', subjectcode, '/ses-UMCU7TGE/merged_bairprf/', subjectcode, '_ses-UMCU7TGE_task-bairprf_run-02_bold.nii']);
n_volumes_run1 = size(nifti_run1, 4);
n_volumes_run2 = size(nifti_run2, 4);
n_volumes = [n_volumes_run1, n_volumes_run2];

nifti_merged = ['/Fridge/users/margriet/subjects/bids_umcupreproc/', subjectcode, '/ses-UMCU7TGE/merged_bairprf/', subjectcode, '_ses-UMCU7TGE_task-bairprf_MERGED_bold/', subjectcode, '_ses-UMCU7TGE_task-bairprf_MERGED_bold-masked-mc-warp.nii'];
...
nifti_run1 = niftiread (['/Fridge/users/margriet/subjects/bids_umcupreproc/', subjectcode, '/ses-UMCU7TSE/merged_bairprf/', subjectcode, '_ses-UMCU7TSE_task-bairprf_run-01_bold.nii']);
nifti_run2 = niftiread (['/Fridge/users/margriet/subjects/bids_umcupreproc/', subjectcode, '/ses-UMCU7TSE/merged_bairprf/', subjectcode, '_ses-UMCU7TSE_task-bairprf_run-02_bold.nii']);
n_volumes_run1 = size(nifti_run1, 4);
n_volumes_run2 = size(nifti_run2, 4);
n_volumes = [n_volumes_run1, n_volumes_run2];

nifti_merged = ['/Fridge/users/margriet/subjects/bids_umcupreproc/', subjectcode, '/ses-UMCU7TSE/merged_bairprf/', subjectcode, '_ses-UMCU7TSE_task-bairprf_MERGED_bold/', subjectcode, '_ses-UMCU7TSE_task-bairprf_MERGED_bold-masked-mc-warp.nii'];

output_dir_umcu7TGE_merged = ['/Fridge/users/margriet/projects/analysis/analyzeprf/results/umcu/', subjectcode, '/ses-UMCU7TSE/merged_bairprf'];
...
% nifti = '/Fridge/users/margriet/subjects/bids_umcupreproc/sub-visual05/ses-UMCU7TSE/sub-visual05_ses-UMCU7TSE_task-bairprf_run-01_bold/sub-visual05_ses-UMCU7TSE_task-bairprf_run-01_bold-masked-mc-warp.nii';
% 
% hdr = niftiinfo(nifti);
% 
% nii = niftiread(nifti);
...
% niftiwrite(mean_nii, '/Fridge/users/margriet/projects/analysis/analyzeprf/results/umcu/sub-visual05/ses-UMCU7TSE/mean.nii', hdr);
