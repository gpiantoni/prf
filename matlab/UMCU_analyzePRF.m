...
subjectcode = 'sub-visual11';               % Enter subject code
subjectnumber = str2num(subjectcode (11:12));

%% Log thresholds
 
% =========  Threshold UMCU preprocessed data ========= % 
thresholdUMCU_3TMB = [700, 750, 200, NaN, 800, 950  NaN, 600, NaN, NaN, 450, 250];
thresholdUMCU_7TGE = [150, 100, 100, NaN, 100, 300, NaN, 250, 250, 250, 200, 150];
