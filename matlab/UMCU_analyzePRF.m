...
if Analyze3TMB == true
    ...
    output_dir_umcu3TMB_merged_denoise = ['/Fridge/users/margriet/projects/analysis/analyzeprf/results_glmdenoise/umcu/', subjectcode, '/ses-UMCU3TMB/merged_bairprf'];
    ...
    % ========= ANALYZEPRF ========= % 
    compute_prf(nifti_merged, n_volumes, output_dir_umcu3TMB_merged, threshold, UseDenoise)
    % ======= PIXELS2DEGREES ======= % 
...
if Analyze7TGE == true
    ...
    output_dir_umcu7TGE_merged_denoise = ['/Fridge/users/margriet/projects/analysis/analyzeprf/results_glmdenoise/umcu/', subjectcode, '/ses-UMCU7TGE/merged_bairprf'];
    ...
    % ========= ANALYZEPRF ========= % 
    compute_prf(nifti_merged, n_volumes, output_dir_umcu7TGE_merged, threshold, UseDenoise)
    % ======= PIXELS2DEGREES ======= % 
...
if Analyze7TSE == true
    ...
    output_dir_umcu7TSE_merged_denoise = ['/Fridge/users/margriet/projects/analysis/analyzeprf/results_glmdenoise/umcu/', subjectcode, '/ses-UMCU7TSE/merged_bairprf'];
    ...
    % ========= ANALYZEPRF ========= % 
    compute_prf(nifti_merged, n_volumes, output_dir_umcu7TSE_merged, threshold, UseDenoise)
    % ======= PIXELS2DEGREES ======= %  
...
% %     
% %     % ========= ANALYZEPRF ========= % 
% %     compute_prf(nifti_merged, n_volumes, output_dir_umcu3TMB, threshold, UseDenoise)
% %     % ======= PIXELS2DEGREES ======= %  
...
% % 
% %     % ========= ANALYZEPRF ========= % 
% %     compute_prf(nifti_merged, n_volumes, output_dir_umcu7TGE, threshold, UseDenoise)
% %     % ======= PIXELS2DEGREES ======= %  
...
% %     
% %     % ========= ANALYZEPRF ========= % 
% %     compute_prf(nifti_merged, n_volumes, output_dir_umcu7TSE, threshold, UseDenoise)
% %     % ======= PIXELS2DEGREES ======= %  
